    ...
    <div className="border-l-2 border-gray-700 dark:border-gray-400 pl-5">
      {sortedEvents.map((event, index) => (
        <div key={index} className="relative mb-5">
          ...
          <div className="absolute -left-[25px] top-1 w-2.5 h-2.5 bg-gray-700 dark:bg-gray-400 rounded-full"></div>
          
          <div className="font-bold text-gray-600 dark:text-gray-300">{event.date}</div>
