   ...
   return (
    <div className="min-h-screen flex flex-col items-center bg-[#F2EFE7] dark:bg-gray-900 transition-colors duration-300 overflow-x-auto">
      ...
      <main className="flex-1 flex flex-col items-center mt-12">
        <h1 className="text-5xl font-extrabold text-[#006A71] dark:text-[#3dd6f3] mb-8 text-center drop-shadow-md">
        ...
        <section className="text-center text-[#006A71] dark:text-[#3dd6f3] text-lg max-w-3xl mx-auto leading-relaxed">
